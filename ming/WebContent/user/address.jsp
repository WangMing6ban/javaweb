...
<div id="templatemo_container">
	...
	<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/../images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
	        ...
	        <div id="templatemo_content_right">
				<div id="dizhi">
					<form action="${pageContext.request.contextPath}/order.action?caozuo=querendizhi" method="post">
					 <c:if test="${addresss!=null }">
					   <c:forEach items="${addresss}" var="addresses">
					   <tr>
					            <td><input type="radio" name="dizhi" value="${addresses.address }" />${addresses.address }&nbsp;</td>${addresses.telephone}
								<td><a href="${pageContext.request.contextPath }/deletadd.action?id=${addresses.id}">删除</a></td>
								<td><a href="${pageContext.request.contextPath }/user/upadd.jsp">修改</a></td>
					  	</tr>
					  	</br>	
