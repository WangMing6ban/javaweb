...
<div id="templatemo_container">
	        	...
	        	<div class="templatemo_content_left_section">
	            	<h1>Categories</h1>
	                 <ul>
	                    ...
	                    <li><a href="${pageContext.request.contextPath}/bookuser.action">查看全部商品</a></li>
	...
	<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/../images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
			...
			<!-- <div style="font-weight:bold;font-size:14px;color:#B5A642">最新商品列表</div> -->
  ...
  &nbsp;首页&nbsp;&nbsp;上一页&nbsp;
						...
						<c:if test="${!(pageCount.isFirst)}">
  &nbsp;<a href='type.action?pageNum=1'>首页</a>&nbsp;
  &nbsp;<a
								href='type.action?pageNum=${pageCount.showPage-1}'>上一页</a>&nbsp;
</c:if>
  ...
  &nbsp;尾页&nbsp;&nbsp;下一页&nbsp;
						...
						<c:if test="${!(pageCount.isLast)}">
  &nbsp;<a
								href='type.action?pageNum=${pageCount.showPage+1}'>下一页</a>&nbsp;
  &nbsp;<a href='type.action?pageNum=${pageCount.count}'>尾页</a>&nbsp;
</c:if>
