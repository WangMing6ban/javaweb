...
function mimayanzheng( password){
	 if(document.getElementById("spand")!=null){
	 ...
	 var xmlhttp; 
		if(password==""){
		    ...
		    xmlhttp.open("POST", "http://localhost:8080/ming/password.action", true);  
		    ...
		    xmlhttp.onreadystatechange = function() {  
		        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {    
		            ...
		            if (response.flag) {  
		            	 console.log("456");
		                document.getElementById("spand").innerHTML = response.content;  
		            }
		            if(!response.flag){
		            	document.getElementById("spand").innerHTML = response.content; 
		            }  
...
<div id="templatemo_container">
	...
	<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/../images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
	        ...
	        <div id="templatemo_content_right">
	        	<div id="dizhi">
					<form action="${pageContext.request.contextPath }/repassword.action"  method="post">
						<table>
							<tr>
								<td>旧密码</td>
