...
<div id="templatemo_container">
  ...
  &nbsp;首页&nbsp;&nbsp;上一页&nbsp;
						...
						<c:if test="${!(pageCount.isFirst)}">
  &nbsp;<a href='newProduct?pageNum=1'>首页</a>&nbsp;
  &nbsp;<a
								href='newProduct?pageNum=${pageCount.showPage-1}'>上一页</a>&nbsp;
</c:if>
  ...
  &nbsp;尾页&nbsp;&nbsp;下一页&nbsp;
						...
						<c:if test="${!(pageCount.isLast)}">
  &nbsp;<a
								href='newProduct?pageNum=${pageCount.showPage+1}'>下一页</a>&nbsp;
  &nbsp;<a href='newProduct?pageNum=${pageCount.count}'>尾页</a>&nbsp;
</c:if>
