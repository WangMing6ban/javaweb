...
<ul>
	...
	<ul>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/book.action"
			target="main-frame">商品列表</a></li>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/tianjia.action"
			target="main-frame">添加商品</a></li>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/viewclass.action"
			target="main-frame">商品分类</a></li>
	</ul>
	</li>
	...
	<ul>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/viewuser.action"
			target="main-frame">查看用户</a></li>
			<li class="menu-item"><a
			href="<%=request.getContextPath() %>/viewadmin.action"
			target="main-frame">查看admin</a></li>
	...
	<ul>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/order.action?caozuo=listAll"
			target="main-frame">查看所有订单</a></li>
		<li class="menu-item"><a
			href="<%=request.getContextPath() %>/order.action?caozuo=sousuo"
			target="main-frame">搜索订单</a></li>
